...
from .commands import (
    ExportCoverCommand, PrepareAIVocalCommand, PrepareRenderCommand, PrepareVocalCleanupCommand, SuggestTransposeCommand,
...
__all__ = [
    ...
    "PrepareAIVocalCommand", "PrepareVocalCleanupCommand", "SuggestTransposeCommand", "PrepareRenderCommand", "ExportCoverCommand",
